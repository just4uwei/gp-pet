 ...
 * ## 两条纪律
 *
 * 1. **状态点在 M3 之前只表达数据层状态**（休市 / 盯盘 / 离线），不表达信号强度。
 *    理由与桌宠表情完全相同：分级要先过 docs/05 §4 的四道闸门（防抖、冷却、
 *    频率上限、免打扰探测），提前点亮等于绕过还没实现的闸门直接骚扰用户。
 *    `push:petState` 现在只会推 OFFLINE / SLEEPY / IDLE，M3 接上闸门后
 *    WATCHING / EXCITED / ALERT 会自动开始出现，这里不需要改。
